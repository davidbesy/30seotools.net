							...
							<div className="row">
								<div className="col-xl-6 col-md-8">
									<ul className="tg-header__top-info left-side list-wrap">
										<li><span className="fw-medium">Now Hiring:</span> Are you a driven and motivated 1st Line Business Solution?</li>
									</ul>
								</div>
										...
										<nav className="tgmenu__nav">
											...
											<div className="tgmenu__action d-none d-lg-block">
												<Link href="#" className="btn menu-tigger">
													<span className="btn-text" data-text="Get Started Now" />
												</Link>
											</div>
